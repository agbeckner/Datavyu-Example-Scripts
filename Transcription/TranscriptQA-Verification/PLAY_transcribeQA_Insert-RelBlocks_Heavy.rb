...
reference_column_name = 'PLAY_id' # uses the first cell from this column to figure out the size of the video or coding region
block_size = 1.0#20*60*1000 # if this is a fraction less than 1, the reference cell is divided this size segments
reliability_size = 1.0#5*60*1000 # if this is a fraction, a rel block is created that is this fraction of the segment
